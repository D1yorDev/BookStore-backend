<?php
		...
		PasswordAuthenticatedUserInterface
	{
		...
		#[Assert\Email]
		#[Groups(['users:read', 'user:create:write', 'user:write', 'user:put:write', 'user:isUniqueEmail:write'])]
		private ?string $email = null;
		
		#[ORM\Column(type: 'string', length: 255)]
		#[Groups(['user:write', 'user:changePassword:write', 'user:create:write'])]
